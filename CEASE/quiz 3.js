    ...
    */
    var quiz = [
        ...
        },
		{
            ...
            "image"         :   "",
            "choices"       :   [
                                    "At the stage of pre-contemplation, the smoker thinks about it but is not serious.",
                                    "At the stage of pre-contemplation, the smoker is actively thinking about quitting but is not ready to make a serious attempt.",
									"Smokers in the preparation stage have a plan and intend to quit next month.",
									"The action stage is the first six months when the smoker is actively quitting.",
									"Maintenance is the period when the ex-smoker takes steps to avoid relapse."
                                ],
            "correct"       :   "At the stage of pre-contemplation, the smoker is seriously thinking about quitting.",
            "explanation"   :   "",
        },
        {
